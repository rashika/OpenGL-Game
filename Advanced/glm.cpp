...
glmReadMTL(GLMmodel* model, char* name)
{
    ...
    for (i = 0; i < nummaterials; i++) {
        ...
        printf("%f\n",model->materials[i].diffuse[0]);
        printf("%f\n",model->materials[i].diffuse[1]);
        printf("%f\n",model->materials[i].diffuse[2]);
        printf("%f\n",model->materials[i].diffuse[3]);
        printf("%f\n",model->materials[i].ambient[0]);
        printf("%f\n",model->materials[i].ambient[1]);
        printf("%f\n",model->materials[i].ambient[2]);
        printf("%f\n",model->materials[i].ambient[3]);
        printf("%f\n",model->materials[i].specular[0]);
        printf("%f\n",model->materials[i].specular[1]);
        printf("%f\n",model->materials[i].specular[2]);
        printf("%f\n",model->materials[i].specular[3]);
    }
}
